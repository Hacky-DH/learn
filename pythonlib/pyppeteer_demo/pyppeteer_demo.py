...
This is just a demo, not working
"""
import random
import asyncio
import pyppeteer
...
class Demo(object):
    ...
    def __init__(self, _url, _username=None, _pwd=None,
                 _chrome_exe=r'C:\Program Files (x86)\Google\Chrome\Application\chrome.exe'):
